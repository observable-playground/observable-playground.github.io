...
var _reactHelmet = __webpack_require__(66);
...
var _RouteData = _interopRequireWildcard(__webpack_require__(67));

var _SiteData = _interopRequireWildcard(__webpack_require__(68));

var _Prefetch = _interopRequireDefault(__webpack_require__(69));

var _Routes = _interopRequireDefault(__webpack_require__(33));

var _Root = _interopRequireDefault(__webpack_require__(70));
...
var PlaygroundWrapper=function PlaygroundWrapper(props){if(typeof document!=='undefined'){var _require=__webpack_require__(86),Playground=_require.Playground;return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Playground,props);}else{return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("pre",null,react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("code",null,props.code));}};
...
var templates = __webpack_require__(29).default;
...
if (typeof document !== 'undefined' && module && module.hot) {
  module.hot.accept("/Users/kos/projects/observable-playground/dist/react-static-templates.js", function () {
    registerTemplates(__webpack_require__(29).default);
  });
}
...
if(typeof window!=='undefined'){glob.Promise=__webpack_require__(65).default;glob.Promise._immediateFn=function(fn){if(isMockMode){return setTimeout(fn,0);}if(typeof setImmediate=='function'){return setImmediate(fn);}return setTimeout(fn,0);};}/**
...
var _ErrorBoundary = _interopRequireDefault(__webpack_require__(71));

var _HashScroller = _interopRequireDefault(__webpack_require__(72));
...
var mock_delayed_execution = __webpack_require__(24);
...
var fromPromise = __webpack_require__(43);
...
var share = __webpack_require__(45);
...
var LIB_VERSION=observable_playground_package["a" /* dependencies */].rxjs;var examples={interval:interval,timer:timer_default.a,'from':from_default.a,'fromPromise':fromPromise_default.a,'of':of,defer:defer,'constructor':creation_constructor,buffer:buffer,mergeMap:mergeMap,switchMap:switchMap,exhaustMap:exhaustMap,concatMap:concatMap,windowToggle:windowToggle,throwError:throwError,'catch':error_handling_catch,retry:retry,retryWhen:retryWhen,share:share_default.a,zip:zip,forkJoin:forkJoin,combineLatest:combineLatest,tap:tap,finalize:finalize,timeInterval:timeInterval,delay:delay,delayWhen:delayWhen,repeat:repeat,pipe:pipe// , 'pausable-buffer': pausableBuffer
};var library={name:'RxJS',version:LIB_VERSION,description:'Reactive Extensions For JavaScript',examples:examples,groups:[{name:'Creation',items:['of','from','fromPromise','interval','timer','defer','constructor']},{name:'Combination',items:['zip','forkJoin','combineLatest']},{name:'Error handling',items:['throwError','catch','retry','retryWhen']},{name:'Transformation',items:['buffer','mergeMap','switchMap','exhaustMap','concatMap','windowToggle']},{name:'Multicasting',items:['share']},{name:'Utility',items:['tap','finalize','timeInterval','delay','delayWhen','repeat','pipe']// ,   { name: 'Recipes'
//     , items:
//         [ 'pausable-buffer'
//         ]
//     }
...
var Gist = __webpack_require__(83);
...
var Editor_EditorComponent = __webpack_require__(76);

// EXTERNAL MODULE: external "react-ace"
var external_react_ace_ = __webpack_require__(47);
...
var TimeLineChart_TimeLineChartComponent = __webpack_require__(80);
...
var Playground_Playground = __webpack_require__(81);
...
var state_state=Object.create(null);var getState=function getState(){return state_state;};var setState=function setState(newState){state_state=Object.assign(Object.create(null),state_state,newState);return state_state;};var resetState=function resetState(){state_state=Object.create(null);return state_state;};
...
var runner_run=function run(sourceCode){resetState();var execStatus,execTime;try{var compiledFn=compiler_compile(sourceCode);var result=Object(mock_delayed_execution["execute"])(compiledFn,consts["a" /* MAX_EXECUTION_TIME */]);execStatus=result.status;execTime=result.time;}catch(err){console.error(err);if(err instanceof Error){execStatus=err;}else{execStatus=new Error(err);}execTime=0;}var _chartState$getState=getState(),lines=_chartState$getState.lines;return{time:execTime,status:execStatus,lines:lines};};

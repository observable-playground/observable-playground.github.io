...
};var library={name:'RxJS',version:LIB_VERSION,description:'Reactive Extensions For JavaScript',examples:examples,groups:[{name:'Creation',items:['of','from','fromPromise','interval','timer','defer','constructor']},{name:'Combination',items:['zip','forkJoin','combineLatest']},{name:'Error handling',items:['throwError','catch','retry','retryWhen']},{name:'Transformation',items:['buffer','mergeMap','switchMap','exhaustMap','concatMap']},{name:'Multicasting',items:['share']},{name:'Utility',items:['tap','finalize','timeInterval','delay','delayWhen','repeat','pipe']// ,   { name: 'Recipes'
//     , items:
//         [ 'pausable-buffer'
//         ]
//     }
...
//# sourceMappingURL=static.2c9f96ce.js.map
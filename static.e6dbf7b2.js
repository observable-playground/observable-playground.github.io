...
var _reactHelmet = __webpack_require__(58);
...
var _RouteData = _interopRequireWildcard(__webpack_require__(59));

var _SiteData = _interopRequireWildcard(__webpack_require__(60));

var _Prefetch = _interopRequireDefault(__webpack_require__(61));

var _Routes = _interopRequireDefault(__webpack_require__(30));

var _Root = _interopRequireDefault(__webpack_require__(62));
...
module.exports = {"b":"0.3.0","a":{"@reach/router":"^1.2.1","axios":"^0.18.0","baconjs":"2.0.11","brace":"^0.11.1","d3":"5.9.1","kefir":"3.8.6","node-sass-chokidar":"^1.3.4","npm-run-all":"^4.1.5","promise-polyfill":"8.1.0","react":"^16.8.1","react-ace":"^6.4.0","react-dom":"^16.8.1","react-hot-loader":"^4.3.12","react-static":"^6.0.18","reset-css":"^4.0.1","rxjs":"6.4.0","rxjs-compat":"6.4.0"}};
...
var _swimmer = __webpack_require__(48);
...
var PlaygroundWrapper=function PlaygroundWrapper(props){if(typeof document!=='undefined'){var _require=__webpack_require__(77),Playground=_require.Playground;return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Playground,props);}else{return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("code",null,props.code);}};
...
if (typeof document !== 'undefined') {
  // Polyfill that shiz!
  __webpack_require__(49); // Do manual polling for intersections every second. This isn't very fast
...
Object(_Users_kos_projects_observable_playground_node_modules_react_universal_component_dist_index_js__WEBPACK_IMPORTED_MODULE_2__["setHasBabelPlugin"])();var universalOptions={loading:function loading(){return null;},error:function error(props){console.error(props.error);return React.createElement("div",null,"An error occurred loading this page's template. More information is available in the console.");}};var t_0=_Users_kos_projects_observable_playground_node_modules_react_universal_component_dist_index_js__WEBPACK_IMPORTED_MODULE_2___default()(babel_plugin_universal_import_universalImport__WEBPACK_IMPORTED_MODULE_1___default()({id:"../src/pages/404.js",load:function load(){return Promise.all([Promise.resolve(/* import() | src-pages-404 */).then(__webpack_require__.bind(null, 32))]).then(function(proms){return proms[0];});},path:function path(){return path__WEBPACK_IMPORTED_MODULE_0___default.a.join(__dirname,'../src/pages/404.js');},resolve:function resolve(){return /*require.resolve*/(32);},chunkName:function chunkName(){return"src-pages-404";}}),universalOptions);var t_1=_Users_kos_projects_observable_playground_node_modules_react_universal_component_dist_index_js__WEBPACK_IMPORTED_MODULE_2___default()(babel_plugin_universal_import_universalImport__WEBPACK_IMPORTED_MODULE_1___default()({id:"../src/pages/gist.js",load:function load(){return Promise.all([Promise.resolve(/* import() | src-pages-gist */).then(__webpack_require__.bind(null, 36))]).then(function(proms){return proms[0];});},path:function path(){return path__WEBPACK_IMPORTED_MODULE_0___default.a.join(__dirname,'../src/pages/gist.js');},resolve:function resolve(){return /*require.resolve*/(36);},chunkName:function chunkName(){return"src-pages-gist";}}),universalOptions);var t_2=_Users_kos_projects_observable_playground_node_modules_react_universal_component_dist_index_js__WEBPACK_IMPORTED_MODULE_2___default()(babel_plugin_universal_import_universalImport__WEBPACK_IMPORTED_MODULE_1___default()({id:"../src/pages/index.js",load:function load(){return Promise.all([Promise.resolve(/* import() | src-pages-index */).then(__webpack_require__.bind(null, 35))]).then(function(proms){return proms[0];});},path:function path(){return path__WEBPACK_IMPORTED_MODULE_0___default.a.join(__dirname,'../src/pages/index.js');},resolve:function resolve(){return /*require.resolve*/(35);},chunkName:function chunkName(){return"src-pages-index";}}),universalOptions);var t_3=_Users_kos_projects_observable_playground_node_modules_react_universal_component_dist_index_js__WEBPACK_IMPORTED_MODULE_2___default()(babel_plugin_universal_import_universalImport__WEBPACK_IMPORTED_MODULE_1___default()({id:"../src/dynamic-pages/Library",load:function load(){return Promise.all([Promise.resolve(/* import() | src-dynamic-pages-Library */).then(__webpack_require__.bind(null, 33))]).then(function(proms){return proms[0];});},path:function path(){return path__WEBPACK_IMPORTED_MODULE_0___default.a.join(__dirname,'../src/dynamic-pages/Library');},resolve:function resolve(){return /*require.resolve*/(33);},chunkName:function chunkName(){return"src-dynamic-pages-Library";}}),universalOptions);var t_4=_Users_kos_projects_observable_playground_node_modules_react_universal_component_dist_index_js__WEBPACK_IMPORTED_MODULE_2___default()(babel_plugin_universal_import_universalImport__WEBPACK_IMPORTED_MODULE_1___default()({id:"../src/dynamic-pages/Example",load:function load(){return Promise.all([Promise.resolve(/* import() | src-dynamic-pages-Example */).then(__webpack_require__.bind(null, 34))]).then(function(proms){return proms[0];});},path:function path(){return path__WEBPACK_IMPORTED_MODULE_0___default.a.join(__dirname,'../src/dynamic-pages/Example');},resolve:function resolve(){return /*require.resolve*/(34);},chunkName:function chunkName(){return"src-dynamic-pages-Example";}}),universalOptions);// Template Map
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_static__WEBPACK_IMPORTED_MODULE_1__["withRouteData"])(function(_ref){var library=_ref.library;return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div",{className:"PageBlock"},react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_static__WEBPACK_IMPORTED_MODULE_1__["Head"],null,react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("title",null,library.name," examples and playground")),react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h1",null,library.name),react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p",null,library.description));}));
...
var PlaygroundWrapper = __webpack_require__(14);
...
glob.Promise=__webpack_require__(57).Promise;/**
...
// setTimeout {{{
mocks.setTimeout=function(cb,timeout){for(var _len4=arguments.length,args=new Array(_len4>2?_len4-2:0),_key4=2;_key4<_len4;_key4++){args[_key4-2]=arguments[_key4];}var task=createTask(timeout,'timeout');task.fn=function(){clearTimeout(task.id);cb.apply(void 0,args);};addTask(task);return task.id;};mocks.clearTimeout=clearTask;// }}}
var Promise=glob.Promise;glob.Promise=void 0;// requestAnimationFrame {{{
...
overridies.forEach(function(key){mocks[key]=null;});glob.Promise=Promise;}return{time:time,status:status};}module.exports={execute:execute};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var promise_polyfill__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(27);
...
/* harmony reexport (default from non-harmony) */ __webpack_require__.d(__webpack_exports__, "Promise", function() { return promise_polyfill__WEBPACK_IMPORTED_MODULE_0___default.a; });
...
var _ErrorBoundary = _interopRequireDefault(__webpack_require__(63));

var _HashScroller = _interopRequireDefault(__webpack_require__(64));
...
var mock_delayed_execution = __webpack_require__(21);
...
var Menu_MenuComponent = __webpack_require__(65);
...
var timer = __webpack_require__(38);
...
var share = __webpack_require__(39);
...
var observable_playground_package = __webpack_require__(9);
...
/* harmony default export */ var bacon_creation_interval = ("const { chart } = require('rp-api');\nconst Bacon = require('baconjs');\n\nBacon\n  .interval(5, '+')\n  .take(5)\n  .subscribe(chart.createBaconObserver());\n");
...
var javascript_ = __webpack_require__(70);

// EXTERNAL MODULE: external "brace/theme/monokai"
var monokai_ = __webpack_require__(71);
...
var Error_ErrorComponent = __webpack_require__(72);
...
var TimeLineChart_TimeLineChartComponent = __webpack_require__(73);
...
return{next:onNext,error:onError,complete:onComplete};};var createRxObserver=function createRxObserver(){var _createObserver=chart_createObserver(),next=_createObserver.next,error=_createObserver.error,complete=_createObserver.complete;return{next:next,error:error,complete:complete};};var createKefirObserver=function createKefirObserver(){var _createObserver2=chart_createObserver(),next=_createObserver2.next,error=_createObserver2.error,complete=_createObserver2.complete;return{value:next,error:error,end:complete};};var createBaconObserver=function createBaconObserver(){var _createObserver3=chart_createObserver(),next=_createObserver3.next,error=_createObserver3.error,complete=_createObserver3.complete;return function(event){if(event.isNext){return next(event.value);}if(event.isError){return error(event.value);}if(event.isEnd){return complete();}};};var chart={createObserver:chart_createObserver,createRxObserver:createRxObserver,createKefirObserver:createKefirObserver,createBaconObserver:createBaconObserver};/* harmony default export */ var playground_api_chart = (chart);
...
external_react_default.a.createElement(TimeLineChartComponent_TimeLineChartComponent,{time:time,lines:lines,viewHeight:this.props.height})));}}]);return Playground;}(external_react_["Component"]);
